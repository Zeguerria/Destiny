                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                    <div class="pd-20 card-box height-100-p">
                        ...
                        <div class="profile-info">
                            <h5 class="mb-20 h5 text-blue">Information Du Livreur</h5>
                            <ul>
                                <li>
                                    <span><i class="icon-copy fi-mail"></i>&ensp;Email Address :</span>
                                    {{Auth::user()->email}}
                                </li>
                                <li>
                                            ...
                                            <form>
                                                <ul class="profile-edit-list row">
                                                    <li class="weight-500 col-md-10">
                                                        <h4 class="text-blue h5 mb-20">Envoyer un Mail</h4>
