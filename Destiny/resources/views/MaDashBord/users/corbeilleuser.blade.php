                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col  d-flex nav justify-content-end">
                                <form class="form me-2" role="search" action="{{url('/searchUserCorbeille')}}">
                                    <label for="search">
                                        ...
                                        <div class="modal fade" id="corbeille{{$value->id}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Restorer l'utilisateur : {{$value->name}} {{$value->prenom}}</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="post" action="{{route('recupUser')}}">
                                                        @csrf
