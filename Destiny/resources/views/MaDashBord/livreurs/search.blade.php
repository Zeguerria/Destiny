                ...
                <table id="example1" class="table table-bordered table-striped table-responsive-md">
                  <thead class="text-center text-center col-md-6 col-md-sm-12">
                    <tr>
                      ...
                      <th scope="col">Nom et Prenom Livreur</th>
                    ...
                    <div class="code-box">
                        <div class="clearfix p-1">
                            <div class="container-fluid pt-2">
                                <div class="row">
                                    <div class="col" >
                                        <a href="javascript:;" data-bs-toggle="tooltip" title="Vider" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-trash" style="font-size: 20px; color:#ff0000;"></i></a>&emsp;
