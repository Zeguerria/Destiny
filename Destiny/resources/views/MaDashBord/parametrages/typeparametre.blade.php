                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <input type="phone" class="form-control" id="" name="contact" placeholder="Entrer la Description">
                              </div>
                            </div>
                          </div>
  ...
  <div class="content-wrapper lebody masection pb-5">
    ...
    <div class="content-header pb-5">
        <div class="col-md-6 col-md-12 bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
            <div class="title">
                <h4 class="mb-0 bread"><!--<i class="fas fa-tools msicons"></i>--><img src="{{asset('mesImages/icon/repair-tools.gif')}}" alt="" class="img img-circle" width="50" height="50">&ensp;Types de Parametre</h4>
            </div>
