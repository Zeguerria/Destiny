                    ...
                    <tbody class="text-center">
                        @foreach($parametres as $key => $value)
                            <tr>
                                ...
                                <td>{{$value->type_parametre->libelle}}</td>
                                ...
                                <div>
                                    <div class="btn-group">
                                                        ...
                                                        <form>
                                                            ...
                                                            <div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="d-flex">Type de parametres</label>
                                        ...
                                        <!-- Corbeille-->
                                        {{-- <button class="btn " data-bs-toggle="tooltip" title="Corbeille" data-toggle="modal" data-target="#corbeille{{$value->id}}"><i class="fas fa-sync" style="font-size: 20px; color:#0446fba6;"></i></button>&ensp; --}}
                                        <div class="modal fade" id="corbeille{{$value->id}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Restorer le Parametre : {{$value->libelle}}</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                        ...
                                        <div class="modal fade" id="supprimer{{$value->id}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Supper le Parametre : {{$value->libelle}}</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
