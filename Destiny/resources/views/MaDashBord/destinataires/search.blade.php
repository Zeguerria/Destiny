    ...
    <div class="modal-dialog  modal-lg">
      <div class="modal-content">
          <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
            <h4 class="modal-title">Ajouter un Destinataire</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
          </div>
            <div class="modal-body">
                <form method="post" action="{{route('ajouterDestinataire')}}">
                    @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <label><i class="fas fa-signature"></i>&ensp;Prenom :</label>
                            <input type="text" class="form-control" id="" name="prenom" placeholder="Entrer le Numero du permis">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                            <label class="d-flex"><i class="fas fa-phone-alt"></i>&ensp;Num telephone</label>
                            <input type="phone" class="form-control" id="" name="contact" placeholder="Entrer le numero de telephone">
                        </div>
                      </div>
                    </div>
  ...
  <div class="content-wrapper lebody masection pb-5">
    ...
    <div class="content-header pb-5">
        <div class="col-md-6 col-md-12 bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
            <div class="title">
                <h4 class="mb-0 bread"><!--<i class="fas fa-users msicons"></i>--><img src="{{asset('mesImages/icon/street-view.gif')}}" alt="" class="img img-circle" width="50" height="50">&ensp;Destinataire</h4>
            </div>
            <nav aria-label="breadcrumb" role="navigation" class="d-flex justify-content-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" >Destinataires</li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col  d-flex nav justify-content-end">
                                <form class="form me-2" role="search" action="{{url('/searchDestinataire')}}">
                                    <label for="search">
                                        <input required="" autocomplete="off" placeholder="Rechercher un Destinataire" name="cherche" id="search" type="text">
                                        <div class="icon">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="modal fade" id="consulter{{$value->id}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-headerbgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Consulter le Destinataire : {{$value->nom}} {{$value->prenom}}</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <div class="modal-footer justify-content-between">
                                                                                <button type="button" class="btn btn-block btn-default" data-dismiss="modal"><i class="fas fa-exclamation-triangle"></i>&ensp;Fermer</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        </form>
                                        ...
                                        <div class="modal fade" id="modifier{{$value->id}}">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                        <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Modifier le Destinataire : {{$value->nom}} {{$value->prenom}}</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="post" action="{{route('modifierDestinataire')}}">
                                                                @csrf
                                                                ...
                                                                <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label class="d-flex" for="consulter{{$value->id}}"><i class="fas fa-signature"></i>&ensp;Nom </label>
                                                                                <input type="text" class="form-control" value="{{$value->nom}}"  id="" name="nom" placeholder="Entrer le domicile">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="d-flex" for="consulter{{$value->id}}"><i class="fas fa-signature"></i>&ensp;Prenom </label>
                                                                                <input type="text" class="form-control" value="{{$value->prenom}}"  id="" name="prenom" placeholder="Entrer le libellé">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                               <label class="d-flex"><i class="fas fa-phone-alt"></i>&ensp;Num telephone</label>
                                                                                <input type="text" class="form-control" value="{{$value->contact}}"  id="contact" name="contact" placeholder="Entrer le numero">
                                                                            </div>
                                                                        </div>
                                        ...
                                        <div class="modal fade" id="corbeille{{$value->id}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Supprimer le Destinataire : {{$value->nom}} {{$value->prenom}}</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="post" action="{{route('corbeilleDestinataire')}}">
                                                            @csrf
                                                            <input type="hidden" name="id" value="{{$value->id}}">
                                                            <!--corp du formulaire debut-->
                                                                <div class="row">
                                        ...
                                        <div class="modal fade" id="supprimer{{$value->id}}">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="{{route('supprimerDestinataire')}}">
                                                            @csrf
                                                            <input type="hidden" name="id" value="{{$value->id}}">
                                                                <!--corp du formulaire debut-->
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="d-flex" for="supprimer{{$value->id}}"><i class="fas fa-signature"></i>&ensp;Nom </label>
                                                                                <input type="text" class="form-control" readonly value="{{$value->domicile}}" id="suprimer{{$value->id}}" name="nom" placeholder="Entrer le nom">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">

                                                                            <div class="form-group">
                                                                                <label class="d-flex" for="suprimer{{$value->id}}"><i class="fas fa-signature"></i>&ensp;Prenom </label>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                               <label class="d-flex"><i class="fas fa-phone-alt"></i>&ensp;Num telephone</label>
                                                                                <input type="text" class="form-control" readonly value="{{$value->contact}}" id="suprimer{{$value->id}}" name="contact" placeholder="Entrer le contact">
                                                                            </div>
                                                                        </div>
