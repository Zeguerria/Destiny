    ...
    <div class="modal-dialog  modal-lg">
      <div class="modal-content">
          <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
            <h4 class="modal-title">Ajouter un Profil Habilitation</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
          </div>
            <div class="modal-body">
                <form method="post" action="{{route('ajouterProfilHabilitation')}}">
                    @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="typeparametre" name="profil_id">
                                @foreach ($profil_habilitationP as $key => $value)
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="typeparametre" name="habilitation_id">
                                @foreach ($profil_habilitationH as $key => $value)
                                <option value="{{$value->id}}">{{$value->libelle}}</option>
                                @endforeach
                            </select>
                        </div>
  ...
  <div class="content-wrapper lebody masection pb-5">
    ...
    <div class="content-header pb-5">
        <div class="col-md-6 col-md-12 bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
            <div class="title">
                <h4 class="mb-0 bread"><!--<i class="fas fa-users msicons"></i>--><img src="{{asset('mesImages/icon/account.gif')}}" alt="" class="img img-circle" width="50" height="50">&ensp;Profils Habilitation</h4>
            ...
            <nav aria-label="breadcrumb" role="navigation" class="d-flex justify-content-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" >Profil Habilitation</li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col  d-flex nav justify-content-end">
                                <form class="form me-2" role="search" action="{{url('/searchProfilHabilitation')}}">
                                    <label for="search">
                                        <input required="" autocomplete="off" placeholder="Rechercher un Profil Habilitation" name="cherche" id="search" type="text">
                                        <div class="icon">
                    ...
                    <tbody class="text-center">
                        @foreach($profilhabilitations as $key => $value)
                            <tr>
                                ...
                                <td>{{$value->habilitation->libelle}}</td>
                                <td>
                                    <div class="btn-group">
                                        <div>
                                            <div class="dropdown">
                                        ...
                                        <div class="modal fade" id="consulter{{$value->id}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-headerbgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    <h4 class="modal-title d-flex"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Consulter le Profil Habilitation : {{$value->profil->libelle}}</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                        ...
                                                        <form>
                                                            ...
                                                            <div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="d-flex"><i class="fas fa-tag"></i>&ensp;Profil</label>
                                                                            <select class="form-control" disabled id="" name="profil_id">
                                                                                @foreach ($profil_habilitationP as $key => $profil_habilitation)
                                                                                <option value="{{$profil_habilitation->id}}" {{($profil_habilitation->id==$value->typeP_id)?"selected":""}}>{{$profil_habilitation->libelle}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                     <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="d-flex"><i class="fas fa-tag"></i>&ensp;Habilitation</label>
                                                                            <select class="form-control" disabled id="" name="habilitation_id">
                                                                                @foreach ($profil_habilitationP as $key => $profil_habilitation)
                                                                                <option value="{{$profil_habilitation->id}}" {{($profil_habilitation->id==$value->typeP_id)?"selected":""}}>{{$profil_habilitation->libelle}}</option>
                                                                                @endforeach
                                                                            </select>
                                        ...
                                        <div class="modal fade" id="modifier{{$value->id}}">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                        <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Modifier le Profil Habilitation : {{$value->profil->libelle}} </h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="post" action="{{route('modifierProfilHabilitation')}}">
                                                                @csrf
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                     ...
                                                                     <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="d-flex"><i class="fas fa-tag"></i>&ensp;Habilitation</label>
                                                                            <select class="form-control"  id="" name="habilitation_id">
                                                                                @foreach ($profil_habilitationP as $key => $profil_habilitation)
                                                                                <option value="{{$profil_habilitation->id}}" {{($profil_habilitation->id==$value->typeP_id)?"selected":""}}>{{$profil_habilitation->libelle}}</option>
                                                                                @endforeach
                                                                            </select>
                                        ...
                                        <div class="modal fade" id="corbeille{{$value->id}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Supprimer le Profil Habilitation : {{$value->profil->libelle}}</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="post" action="{{route('corbeilleProfilHabilitation')}}">
                                                            @csrf
                                                            <input type="hidden" name="id" value="{{$value->id}}">
                                                            <!--corp du formulaire debut-->
                                                            <div class="row">
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-black">
                                                        <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Supprimer le Client : {{$value->nom}} {{$value->prenom}}</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="post" action="{{route('supprimerProfilHabilitation')}}">
                                                            @csrf
                                                            <input type="hidden" name="id" value="{{$value->id}}">
                                                                <!--corp du formulaire debut-->
                                                                <div class="row">
                                        ...
                                        {{-- <div class="modal fade" id="consulter{{$value->id}}">
                                            <div class="modal-dialog  modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                        <h4 class="modal-title">Consulter le Profil Habilitation</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Profil</label>
                                                                        <select class="form-control" id="profil_id"  disabled name="profil_id">
                                                                            @foreach ($profil_habilitationP as $key => $value)
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Habilitation</label>
                                                                        <select class="form-control" id="profil_id"  disabled name="habilitation_id">
                                                                            @foreach ($profil_habilitationH as $key => $value)
                                                                            <option value="{{$value->id}}" {{('$value->libelle')?"selected":""}}>{{$value->libelle}}</option>
                                                                            @endforeach
                                                                        </select>
                                        ...
                                        {{-- <div class="modal fade" id="modifier{{$value->id}}">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                        <h4 class="modal-title">Modifier Profil Habilitation</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                        ...
                                        {{-- <div class="modal fade" id="corbeille{{$value->id}}">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    <h4 class="modal-title">Supprimer le Profil Habilitation</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                            ...
                                                            <!--corp du formulaire debut-->
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Profil </label>
                                                                            <select class="form-control" id=""  disabled name="profil_id">
                                                                                @foreach ($profil_habilitationP as $key => $value)
                                                                                <option value="{{$value->id}}" {{('$value->libelle')?"selected":""}}>{{$value->libelle}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Habilitation</label>
                                                                            <select class="form-control" id="typeparametre"  disabled name="habilitation_id">
                                                                                @foreach ($profil_habilitationH as $key => $value)
                                                                                <option value="{{$value->id}}" {{('$value->libelle')?"selected":""}}>{{$value->libelle}}</option>
                                                                                @endforeach
                                                                            </select>
                                                        ...
                                                        <form method="post" action="{{route('supprimerProfilHabilitation')}}">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Habilitation </label>
                                                                        <select class="form-control" id=""  disabled name="habilitation_id">
                                                                            @foreach ($profil_habilitationH as $key => $value)
                                                                            <option value="{{$value->id}}" {{('$value->libelle')?"selected":""}}>{{$value->libelle}}</option>
                                                                            @endforeach
                                                                        </select>
