                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="d-flex"><i class="fas fa-image"></i>&ensp;Photo</label>
  ...
  <div class="content-wrapper lebody masection pb-5">
    ...
    <div class="content-header pb-5">
        <div class="col-md-6 col-md-12 bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
            <div class="title">
                <h4 class="mb-0 bread"><!--<i class="fas fa-users msicons"></i>--><img src="{{asset('mesImages/icon/cab.gif')}}" alt="" class="img img-circle" width="50" height="50">&ensp;Vehicules</h4>
            </div>
                    ...
                    <tbody class="text-center">
                        @foreach($vehicules as $key => $value)
                            <tr>
                                ...
                                <td>{{$value->marqueVehicule}}</td>
                                <td>{{$value->numeroMatricule}}</td>
                                <td>
                                    <center>
                                        <img src="{{asset($value->le_profil)}}" alt="" class="img img-circle" width="50" height="50">
                                    </center>
                                </td>
                                <td>{{$value->livreur->user->name}} {{$value->livreur->user->prenom}}</td>
                                <td>
                                    <div class="dropdown">
                                    ...
                                    <div class="modal fade" id="corbeille{{$value->id}}">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="{{route('corbeilleVehicule')}}">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{$value->id}}">
                                                        <!--corp du formulaire debut-->
